    ...
    <Layout>
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-gray font-ibm-plex">ICSTSS-2025 Conference Committee</p>
        </div>
        ...
        <div className="mt-12 bg-soft-sand p-6 rounded-lg border border-gray-200">
          ...
          <p className="text-slate-gray font-ibm-plex">
            ...
            <a href="mailto:ICSTSS.conference@gmail.com" className="text-accent-blue hover:underline ml-1">
              ICSTSS.conference@gmail.com
            </a>
          </p>
        </div>
      </div>
