    ...
    <Layout>
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-gray font-ibm-plex">Join us in Hybrid Mode for ICSTSS-2025</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-soft-sand to-white p-8 rounded-lg border border-gray-200 mb-12">
          <div className="text-center">
            ...
            <p className="text-lg text-slate-gray font-ibm-plex max-w-3xl mx-auto">
              ICSTSS-2026 will be conducted in hybrid mode, allowing participants to join either online via ZOOM 
