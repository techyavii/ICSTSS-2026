      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="bg-neo-primary text-white p-8 rounded-lg mb-8">
          ...
          <div className="space-y-4">
            <p className="neo-body leading-relaxed">
              ICSTSS-2026 is committed to protecting the privacy and security of all participants' personal information. We collect and process personal data only for legitimate conference purposes including registration, paper submission, review process, and communication.
            </p>
            <p className="neo-body leading-relaxed">
        ...
        <div className="bg-neo-accent p-8 rounded-lg">
          ...
          <p className="neo-body text-neo-secondary font-semibold">
            Email: ICSTSS.conference@gmail.com
          </p>
        </div>
      </div>
    </Layout>
